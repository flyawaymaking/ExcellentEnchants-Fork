...
public class FireResistEnchant extends GameEnchantment implements PassiveEnchant {

    public FireResistEnchant(@NotNull EnchantsPlugin plugin, @NotNull File file, @NotNull EnchantData data) {
        super(plugin, file, data);
        this.addComponent(EnchantComponent.POTION_EFFECT, PotionEffects.permanent(PotionEffectType.FIRE_RESISTANCE));
