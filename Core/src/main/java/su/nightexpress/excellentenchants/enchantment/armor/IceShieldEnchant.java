...
public class IceShieldEnchant extends GameEnchantment implements DefendEnchant {
    ...
    public IceShieldEnchant(@NotNull EnchantsPlugin plugin, @NotNull File file, @NotNull EnchantData data) {
        ...
        this.addComponent(EnchantComponent.PROBABILITY, Probability.addictive(10, 3));
        this.addComponent(EnchantComponent.POTION_EFFECT, PotionEffects.temporal(PotionEffectType.SLOWNESS, Modifier.addictive(3).perLevel(0).capacity(10)));
